 ...
 * documentation
 */
public class StartQueryTask extends AsyncTask<Void, Void, HashMap<String, Object>> {
     ...
     */
    public StartQueryTask(String username, LsQueryUser usingClass, int queryType){
