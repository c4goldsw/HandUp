package com.handup.handup.controller.login;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, AsyncResponse {
    ...
    public static final String SUCCESSFUL_LOGIN = "12341234asdf43f";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.login_email_text_view)).setInputType(
                InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
    }


    /**
     * This code was taken from this SO post:
    ...
    private void attemptLogin() {
        ...
        //TODO: Check to see if we're connected to the internet before connecting
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password, AsyncResponse a) {
            mEmail = email;
            mPassword = password;
            ar = a;
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            //Attempt login
            try {
                response = oauthService.generateOAuth2PasswordRequest(mEmail, mPassword);
                if(response.getAccessToken().equals(""))//TODO: properly check for HTTP response code
                    return false;
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ar.returnResponse(LoginActivity.SUCCESSFUL_LOGIN);
            } else {
